...
const unrepettedSkills = allSkills.filter((skill, index) => allSkills.indexOf(skill) === index);
console.log(unrepettedSkills);

return unrepettedSkills.sort();
...
//   const unrepettedSkills = allSkills.reduce((uniqueSkill, skill) => uniqueSkill.includes(skill) ? uniqueSkill : [...uniqueSkill, skill],[]);
//   console.log(unrepettedSkills);
